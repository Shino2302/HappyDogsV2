using HappyDogsV2.GraphicResources;
using HappyDogsV2.ViewModel;
using System.Timers;

namespace HappyDogsV2.Views.MainMenu.PetProfiles;

public partial class PetStatistics : ContentPage
{
	public PetStatistics()
	{
		InitializeComponent();
        BindingContext = new PetStatisticsViewModel(Navigation);
